(() => {
    ...
    let iconSearch = document.querySelector(".menu__item_searchicon");
    if (iconSearch) iconSearch.addEventListener("click", (function() {
        iconSearch.classList.toggle("active");
        iconSearch.parentNode.classList.toggle("active");
        document.documentElement.classList.toggle("search");
        let inp = iconSearch.parentNode.querySelector("input");
        inp.focus();
    }));
    let menuBody = document.querySelector(".menu__body");
    if (menuBody) menuBody.addEventListener("click", (function() {
        document.documentElement.classList.remove("menu-open");
        document.documentElement.classList.remove("lock");
    }));
    let products = document.querySelector(".all_products");
    ...
    if (showmorebtn) showmorebtn.addEventListener("click", (function() {
        ...
        if (showmorebtn.parentNode.classList.contains("show")) showmore.style.height = products.offsetHeight + 35 + "px";
        if (!showmorebtn.parentNode.classList.contains("show")) showmore.style.height = 805 + "px";
    }));
